...
class StoreAdapter(val context: Context, var datalist: ArrayList<StoreModal>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.rv_stores, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.storerating.text =
            datalist.get(position).storerating.toString() + "(" + datalist.get(position).noofrating + ")"
        ...
        database.child("users").child(uid.toString())
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    val userlat =
                        snapshot.child("userlat").getValue(String::class.java)!!.toDouble()
                    val userlong =
                        snapshot.child("userlong").getValue(String::class.java)!!.toDouble()
